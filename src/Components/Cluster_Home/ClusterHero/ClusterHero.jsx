...
export default function ClusterHero() {
  ...
  const content = {
    ...
    description: "Initialize your connection to the Choice Technology neural network. Monitor live nodes, manage compute resources, and secure your digital ecosystem in real-time."
  };
