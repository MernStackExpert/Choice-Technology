    ...
    <div className="relative flex flex-col items-center w-full min-h-[90vh] pt-10 md:pt-20 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center w-full px-4 md:px-0">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="text-lg md:text-2xl text-gray-400 font-medium h-8 md:h-10">
              <Typewriter
                words={["MERN Stack Expert", "3D Web Experiences", "Scalable Solutions", "Next.js Performance"]}
                loop={0}
                cursor
                cursorStyle="|"
                typeSpeed={70}
            ...
            <p className="text-gray-400 text-xs md:text-lg max-w-xl leading-relaxed font-light">
              ...
              high-performance user experiences. Specializing in modern web architectures.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3.5 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold rounded-xl shadow-lg shadow-cyan-500/20"
            >
              Start Project
            </motion.button>
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3.5 border border-white/10 text-white font-semibold rounded-xl backdrop-blur-md"
            >
              Our Arsenal
            </motion.button>
          </div>
        ...
        >
          ...
          >
            ...
            >
              <div className="text-xs text-cyan-400 font-bold tracking-widest uppercase mb-1">Status</div>
      ...
      >
        <div className="relative w-24 h-24 flex items-center justify-center">
          ...
          <ArrowDown className="text-cyan-400 group-hover:translate-y-2 transition-transform duration-300" size={24} />
        </div>
      </motion.div>
