...
const data = [
  {
    title: "Our Mission",
    desc: "To empower businesses by building high-performance, scalable, and visually immersive digital solutions using the modern MERN stack.",
    icon: <Target className="text-cyan-400" size={32} />,
    borderColor: "after:from-cyan-500",
  },
  {
    title: "Our Vision",
    desc: "To become a global leader in creative web development, where 3D experiences and seamless technology meet business growth.",
  ...
  return (
    <div className="space-y-16">
      <header className="text-center">
        ...
        >
          Our <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent italic">Purpose</span>
        </motion.h2>
      </header>
