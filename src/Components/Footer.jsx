      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
        ...
        >
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
              Elevating digital experiences through cutting-edge technology and
              immersive 3D web solutions.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={item}
                  className="group flex items-center text-gray-400 hover:text-cyan-400 transition-colors cursor-pointer text-sm"
                >
        ...
        >
          <p className="text-[10px] md:text-xs text-gray-500 tracking-widest uppercase text-center sm:text-left">
            © {currentYear} Arshe Technology. All rights reserved.
          </p>
