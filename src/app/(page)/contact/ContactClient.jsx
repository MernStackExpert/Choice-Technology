          ...
          <div className="lg:col-span-5 space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-gray-400 leading-relaxed">
                Whether you're looking for a bespoke MERN stack solution, a
                $5/month managed subscription, or a long-term technical
                partnership, we are ready to scale your vision.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-cyan-500/20 bg-cyan-500/5">
              <h4 className="text-white font-bold mb-4">
                Why Arshe Technology?
              </h4>
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-sm text-gray-300">
                  <Zap size={16} className="text-cyan-400" /> Rapid Development
                  Cycle
                </li>
                <li className="flex items-center gap-2 text-sm text-gray-300">
                  <Shield size={16} className="text-purple-400" /> Enterprise
                  Grade Security
                </li>
                <li className="flex items-center gap-2 text-sm text-gray-300">
                  <Clock size={16} className="text-green-400" /> 24/7 Managed
                  Support
                </li>
              </ul>
            </div>
