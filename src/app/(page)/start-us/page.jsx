...
export const metadata = {
  title: "Initialize Your Project | Arshe Technology",
  description:
    "Scale your business with our tailored digital models. Join Arshe Technology for high-performance web solutions.",
};
    ...
    <main className="min-h-screen pt-24 pb-20 bg-transparent text-white">
      <div className="max-w-7xl mx-auto px-6 mb-20 text-center relative z-10">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg italic backdrop-blur-sm p-2 rounded-xl">
          ...
          Our team will verify your details and connect with you within 24
          hours.
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 border-y border-white/5 py-10 backdrop-blur-md bg-white/[0.02] rounded-3xl">
          {[
            ...
            >
              <div className="p-3 bg-white/5 border border-white/10 rounded-2xl shadow-xl shadow-black/20">
                {item.icon}
              </div>
