      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              Arshe Technology is more than just a development agency; we are
              your strategic technology partner. Based on a foundation of
              cutting-edge MERN stack expertise, we bridge the gap between
              complex business logic and stunning visual storytelling.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              Our mission is to democratize high-end technology. Whether through
              our managed subscription models for small businesses or bespoke
              enterprise architectures, we ensure that every brand has access to
              a premium digital presence.
            </motion.p>
          </div>
        </header>

        {/* The Arshe Technology Advantage */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-40">
          {expertise.map((item, i) => (
            ...
            >
              <div
                className="mb-6 p-4 w-fit bg-white/5 rounded-2xl text-3xl group-hover:scale-110 transition-transform"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <ul className="space-y-6">
                {[
                  {
                    t: "Customized Builds",
                    d: "Tailored to your specific industry needs using Next.js.",
                  },
                  {
                    t: "Subscription Excellence",
                    d: "Continuous maintenance and hosting at a competitive $5/mo rate.",
                  },
                  {
                    t: "Partnership Growth",
                    d: "We invest in your vision as technical equity partners.",
                  },
                  {
                    t: "Global Standards",
                    d: "Performance and SEO optimized for a global audience.",
                  },
                ].map((feature, i) => (
            ...
            <div className="relative aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-cyan-500/20 to-purple-500/20 flex items-center justify-center border border-white/10">
              <div className="text-center p-10">
                <Globe
                  className="mx-auto text-cyan-400 mb-6 animate-pulse"
                  size={80}
                />
                ...
                <p className="text-gray-400 text-sm italic">
                  Delivering digital excellence across borders, powered by
        ...
        >
          ...
          <Link
            href="/start-us"
            className="px-12 py-5 bg-white text-black rounded-full font-black text-lg hover:bg-cyan-400 hover:scale-105 transition-all cursor-pointer shadow-[0_0_30px_rgba(255,255,255,0.1)]"
          >
            Start a Project with Arshe Technology
          </Link>
        </motion.div>
      </div>
    </section>
