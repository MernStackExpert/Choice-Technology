      ...
      <div className="relative z-10 w-full max-w-4xl text-center">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-8">
            ...
            >
              <MoveLeft size={18} className="group-hover:-translate-x-1 transition-transform cursor-pointer" />
              Return Back
            </motion.button>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => router.push("/")}
              className="w-full md:w-auto px-10 py-4 bg-cyan-600 rounded-2xl flex items-center justify-center gap-3 text-black text-xs font-black uppercase tracking-widest shadow-[0_0_30px_rgba(8,145,178,0.3)] hover:shadow-cyan-500/50 transition-all cursor-pointer"
            >
              <Home size={18} />
              Home Base
            </motion.button>
